...
for inputVersion in range(4):
    ...
    for CB_version in range(8):
        ...
        f = open('results/' + y + '/sequentialCarbonAware/'+ x +'sequentialCarbonAwareBaseline_' + y + '.csv', 'w')
        writer = csv.writer(f)
        writer.writerow(row)
        f.close()
        ...
        for t in range(8760): # Itero per tutte le ore dell'anno 
            ...
            f = open('results/' + y + '/sequentialCarbonAware/'+ x +'sequentialCarbonAwareBaseline_' + y + '.csv', 'a')
